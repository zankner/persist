            ...
            <div className="pt-nav">
                <div className="progress rounded-0 sticky-top" style={{height: '8px', top: '78px'}}>
                    <div className="progress-bar" role="progressbar" style={{
                        width: "20%", ariaValuenow: "20", ariaValuemin: "0",
                        ariaValuemax: "100"
                    }}/>
                </div>
                <section className="py-5">
                    <div className="container">
                        ...
                        <h1 className="h2 mb-5"> Basic information <span
                            className="text-muted float-right">Step 1</span></h1>
                        <form>
                            <div className="row form-block">
                                <div className="col-lg-4">
                                    <h4>Basic</h4>
                                    <p className="text-muted text-sm">His room, a proper human room although a little
                                        too small, lay
                                ...
                                <div className="col-lg-7 ml-auto">
                                    ...
                                    <div className="form-group">
                                        ...
                                        </select><small className="form-text text-muted" id="propertyTypeHelp">One
                                        morning, when Gregor
