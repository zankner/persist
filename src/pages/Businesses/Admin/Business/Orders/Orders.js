                ...
                <section className="py-5">
                    <div className="container">
                        ...
                        <div className="d-flex justify-content-between align-items-end mb-5">
                            <h1 className="hero-heading mb-0">Your nearest bookings</h1><a className="btn btn-link text-muted"
                                                                                           href="#">Past bookings</a>
                        </div>
                        <div className="d-flex justify-content-between align-items-center flex-column flex-lg-row mb-5">
                            ...
                            <div className="text-center">
                                ...
                                </select><a className="btn btn-outline-secondary" href="#"><i className="fa fa-download mr-2"></i>Download
                                CSV</a>
                            </div>
                        </div>
                        <div className="list-group shadow mb-5"><a className="list-group-item list-group-item-action p-4"
                            ...
                            <div className="row">
                                <div className="col-lg-4 align-self-center mb-4 mb-lg-0">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        className="avatar avatar-sm avatar-border-white ml-3" src="/img/avatar/avatar-0.jpg"
                                        alt="Jack London" />
                                    </div>
                                ...
                                <div className="col-lg-8">
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-lg-3 align-self-center"><span
                                            ...
                                            className="fa fa-check fa-fw mr-2"> </i>Booking paid</span><br className="d-none d-lg-block" /><span
                                            className="text-primary text-sm text-uppercase"><i className="fa fa-check fa-fw mr-2"> </i>Confirmed</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-4 align-self-center mb-4 mb-lg-0">
                                    <div className="d-flex align-items-center mb-3">
                                        <h2 className="h5 mb-0">Weeks Garrett</h2><img className="avatar avatar-sm avatar-border-white ml-3"
                                ...
                                <div className="col-lg-8">
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-lg-3 align-self-center"><span
                                            className="text-primary text-sm text-uppercase mr-4 mr-lg-0"><i
                                            className="fa fa-check fa-fw mr-2"> </i>Booking paid</span><br className="d-none d-lg-block" /><span
                                            className="text-muted text-sm text-uppercase"><i className="fa fa-times fa-fw mr-2"> </i>Confirmed</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-4 align-self-center mb-4 mb-lg-0">
                                    <div className="d-flex align-items-center mb-3">
                                        <h2 className="h5 mb-0">Fisher Bauer</h2><img className="avatar avatar-sm avatar-border-white ml-3"
                            ...
                            <div className="row">
                                <div className="col-lg-4 align-self-center mb-4 mb-lg-0">
                                    <div className="d-flex align-items-center mb-3">
                                        <h2 className="h5 mb-0">Aguilar Webb</h2><img className="avatar avatar-sm avatar-border-white ml-3"
                            ...
                            <div className="row">
                                <div className="col-lg-4 align-self-center mb-4 mb-lg-0">
                                    <div className="d-flex align-items-center mb-3">
                                        <h2 className="h5 mb-0">Melton Simon</h2><img className="avatar avatar-sm avatar-border-white ml-3"
